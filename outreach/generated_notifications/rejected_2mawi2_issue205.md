...
I noticed your tool **Schaltwerk** (https://github.com/hesreallyhim/awesome-claude-code/issues/205) was rejected in hesreallyhim/awesome-claude-code, even though it passed validation.
...
- Your tool was rejected after **21 days** with status: Rejected - 'not optimal for orchestrators'
...
Search for "Schaltwerk" to see your listing with:
- Full description
...
- **Gatekeeping Evidence**: [Issue #205 in Analysis](https://github.com/thedotmack/awesome-claude-code/blob/main/GATEKEEPING_ANALYSIS.md#part-1-validated-submissions-that-were-rejected)
