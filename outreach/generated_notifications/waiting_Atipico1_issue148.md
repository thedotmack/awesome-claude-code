...
I noticed your tool **Claudable** (https://github.com/hesreallyhim/awesome-claude-code/issues/148) has been waiting **62+ days** for approval in hesreallyhim/awesome-claude-code, even though it passed validation.
...
**Special Note**: Assigned to maintainer but still waiting
...
- Your tool passed validation but has been waiting **62+ days**
...
Search for "Claudable" to see your listing with:
- Full description
...
- **Gatekeeping Evidence**: [Issue #148 in Analysis](https://github.com/thedotmack/awesome-claude-code/blob/main/GATEKEEPING_ANALYSIS.md#part-2-validated-submissions-waiting-still-open)
